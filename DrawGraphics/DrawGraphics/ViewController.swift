...
class ViewController: UIViewController {
    ...
    @IBAction func btnDrawLine(_ sender: UIButton) {
        ...
        context.move(to: CGPoint(x: 270, y: 50))
        context.addLine(to: CGPoint(x: 70, y: 250))
        context.strokePath()
        //직선
        context.setLineWidth(6.0)
        context.setStrokeColor(UIColor.green.cgColor)
        context.move(to: CGPoint(x: 170, y: 50))
        context.addLine(to: CGPoint(x: 170, y: 250))
        context.strokePath()
    ...
    @IBAction func btnDrawRectangle(_ sender: UIButton) {
        ...
        context.addLine(to: CGPoint(x: 20, y: 150))
